...
<template>
  <footer class="py-8 px-6 border-t border-t-white/[0.05]">
    <div class="max-w-[1200px] mx-auto flex justify-between items-center max-md:flex-col max-md:gap-4">
      <p class="text-sm text-muted">&copy; 2026 Shawn Niu. 用好奇心和代码构建。</p>

      <Transition name="fade-up">
        <button v-if="showButton"
          class="w-11 h-11 rounded-full border border-stroke bg-white/[0.025] flex items-center justify-center text-muted hover:text-white hover:border-[#4E85BF] hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(78,133,191,0.25)] transition-all duration-200"
          aria-label="回到顶部"
          @click="scrollToTop">
